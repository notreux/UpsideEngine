...
*/ 
export declare interface AuthorityService extends EventEmitter {
/**
...
*/
SetAuthority(object: BaseObject, authorityType: AuthorityType): null;
/**
...
*/
GetAuthority(object: BaseObject): AuthorityType;
}
